...
t = (1, 2, 3)
m = (4, 5, 6)
p = t + m; print(p)      # se unen t y m
p1 = t*3; print (p1)     # se triplica la t
p3 = t < m; print(p3)    # operacion booleana
p4 = t <= m; print(p4)   # operacion booleana
p5 = t > m; print(p5)    # operacion booleana
p6 = t >= m; print(p6)   # operacion booleana
p7 = t != m; print(p7)   # operacion booleana
